    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-grid">
          <div>
            <div className="brand"><span>DP</span>{BUSINESS.name}</div>
            <p className="muted">Straightforward property guidance for buyers and families across Dombivli and Thakurli.</p>
          </div>
          <div><b>Explore</b><Link href="/properties">All properties</Link><Link href="/about">About us</Link><Link href="/contact">Contact</Link></div>
